...
List_of_path = ["/home/lorenzo/Documenti/UPF/DeepRL/Plots/data/HRL_totR_2/", "/home/lorenzo/Documenti/UPF/DeepRL/Plots/data/HRL_HC_totR_2/", "/home/lorenzo/Documenti/UPF/DeepRL/Plots/data/SIL_totR_2/", "/home/lorenzo/Documenti/UPF/DeepRL/Plots/data/SIL_HC_totR_2/"]

List_of_color= [('#CC4F1B', '#FF9848') , ('#4B6034', '#7FE90B') , ('#0A305D', '#0471F1'), ('#581C58', '#EB13EB')]
List_of_title= ["hrl_sil", "hrl_sil_with_count", "sil", "sil_with_count"]
...
for i, path in zip(range(len(List_of_path)), List_of_path):
	...
	list_results_x, list_results_y = open_file_2_ms(path)
...
file_name= "test"
plt.savefig(path_2_save + file_name)
plt.show()
