...
from Wrappers_Env import Montezuma_RAM_position_wrapper
...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(2)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + ' - Montezuma_HRL_E_GREEDY-1/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'Montezuma_HRL_E_GREEDY'
        ...
        self.wrapper = Montezuma_RAM_position_wrapper(environment, self.wrapper_params)
    ...
    def reset(self):
        ...
        self.shared_dense_layers = SharedDenseLayers(256, 0.05)
        ...
        self.option_params = {
            ...
            "shared_representation": self.shared_dense_layers,
            "weight_mse": 0.5,
