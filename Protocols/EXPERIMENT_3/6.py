...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = [0]
        self.MAX_R = 3
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(__file__)) + '  - NO TRANSFER -  SIL-HC-totr' + str(self.MAX_R) + 'v2/')
        ...
        self.TEST_TRANSFER_PROBLEM = ['GE_MazeTreasure16keyDoor2-v0']
