...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = [0]
        self.MAX_R = 3
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(__file__)) + '  - NO TRANSFER -  HRL-SIL-totr' + str(self.MAX_R) + '/')
        ...
        self.PROBLEM = 'GE_MazeTreasure15keyDoor0-v0'
        self.TEST_TRANSFER_PROBLEM = ['GE_MazeTreasure15keyDoor1-v0', 'GE_MazeTreasure15keyDoor2-v0']
