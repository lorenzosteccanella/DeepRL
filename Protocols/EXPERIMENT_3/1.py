...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = [0]
        self.MAX_R = 3
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(__file__)) + '  -  HRL-SIL-totr' + str(self.MAX_R) + 'v3/')
        ...
        self.wrapper_env = getattr(importlib.import_module('Wrappers_Env.GridEnvKeyDoor.Position_observation_wrapper_key_door_totr' + str(self.MAX_R) ), 'Position_observation_wrapper_key_door_totr' + str(self.MAX_R))
