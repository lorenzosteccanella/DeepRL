...
from Wrappers_Env import Gridenv_DiffusionTimeCluster
...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(2)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  DiffusionTime_PseudoCount/')
        ...
        self.wrapper = Gridenv_DiffusionTimeCluster(environment, self.wrapper_params)
