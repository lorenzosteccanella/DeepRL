...
from Wrappers_Env import Gridenv_KNN_wrapper
...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(2)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  KNN/')
        ...
        self.wrapper = Gridenv_KNN_wrapper(environment, self.wrapper_params)
