...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(2)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + " - " + (os.path.basename(os.path.dirname(__file__))) + ' - 3/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'Key_Door_HRL_E_GREEDY'
        self.NUMBER_OF_EPOCHS = 2000

        self.PROBLEM = 'GE_MazeKeyDoor10key1color1-v0'
        self.TEST_TRANSFER_PROBLEM = ['GE_MazeKeyDoor10pick_up_objects1color1-v0']
