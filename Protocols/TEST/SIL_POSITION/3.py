...
class variables():
    ...
    def __init__(self):
        ...
        environment = gym.make(self.PROBLEM)     # WARNING WARNING WARNING WARNING
        environment = NoopResetEnv(environment)  # WARNING WARNING WARNING WARNING
        environment = FireResetEnv(environment)  # WARNING WARNING WARNING WARNING
    ...
    def reset(self):
        ...
        self.agent = HrlAgent_SubGoal_Plan_heuristic_count_PR_v2(*self.agent_params)
