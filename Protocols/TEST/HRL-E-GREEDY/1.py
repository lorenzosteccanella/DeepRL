from Agents import HrlAgent, HrlAgent_nextV_PR, RandomAgentOption, A2COption, WayPointsAgent_nextV_PR
import gym
...
class variables():
    ...
    def reset(self):
        ...
        self.agent = WayPointsAgent_nextV_PR(self.option_params, self.random_agent, self.exploration_fn, self.PSEUDO_COUNT, self.LAMBDA, self.MIN_EPSILON, 1.1, -1.1, self.SAVE_RESULT)
