...
from Wrappers_Env import Flat_Position_observation_wrapper_key_door16
...
class variables():
    ...
    def __init__(self):
        ...
        self.wrapper = Flat_Position_observation_wrapper_key_door16(environment, self.wrapper_params)
