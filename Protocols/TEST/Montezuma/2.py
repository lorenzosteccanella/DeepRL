...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(1)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  nextV_PR_Montezuma_position_abstraction_4/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'nextV_PR_Montezuma_position_abstraction_4'
