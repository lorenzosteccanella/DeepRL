...
class variables():
    ...
    def __init__(self):
        ...
        self.MAX_R = 3
        self.MAX_MOVES = 300
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  HRL-SIL-3-totr' + " - " + str(self.MAX_R) + " - " + str(self.MAX_MOVES) +'/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'HRL-SIL-totr'+str(self.MAX_R) + " - " + str(self.MAX_MOVES)
        ...
        self.TEST_TRANSFER_PROBLEM = ['GE_MazeTreasure16key2-v0', 'GE_MazeTreasure16key3-v0']
