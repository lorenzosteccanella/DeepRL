...
class variables():
    ...
    def __init__(self):
        ...
        self.MAX_R = 3
        self.MAX_MOVES = 300
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  SIL-3-totr' + " - " + str(self.MAX_R) + " - " + str(self.MAX_MOVES) +'/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'SIL-totr'+str(self.MAX_R) + " - " + str(self.MAX_MOVES)
