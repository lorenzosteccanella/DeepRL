from Agents import HrlAgent, HrlAgent_heuristic_count_PR, RandomAgentOption, PPOOption, HrlAgent_SubGoal_Plan_heuristic_count_PR
import gym
...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(1)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  heuristic_count_TEST_GOAL_PPO_POSITION_1/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'Position_GOAL_PPO_HRL_E_GREEDY'
    ...
    def reset(self):
        ...
        self.option_params = {
            ...
            "batch_size": 8,
            "steps_of_training": 4,
            "n_step_update_weights": 4,  # this should always be the same of steps_of_training
