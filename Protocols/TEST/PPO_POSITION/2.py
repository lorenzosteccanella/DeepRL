...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(1)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  heuristic_count_TEST_PPO_POSITION_XL/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'Position_XL_PPO_HRL_E_GREEDY'
