...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = range(1)
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(os.path.dirname(__file__))) + '  -  heuristic_count_TEST_SIL_MONTEZUMA_4/')
    ...
    def reset(self):
        ...
        self.option_params = {
            ...
            "weight_mse": 0.5,
            "sil_weight_mse": 0.05, #0.01,   # WARNING
