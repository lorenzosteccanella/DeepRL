...
class variables():
    ...
    def __init__(self):
        ...
        self.seeds = [0]
        self.MAX_R = 100
        self.RESULTS_FOLDER = (os.path.basename(os.path.dirname(__file__)) + '  -  HRL-noPR-totr' + str(self.MAX_R) + '- v1/')
        self.SAVE_RESULT = SaveResult(self.RESULTS_FOLDER)
        self.FILE_NAME = 'HRL-noPR-totr' + str(self.MAX_R)
    ...
    def reset(self):
        ...
        self.agent = HrlAgent(*self.agent_params)
