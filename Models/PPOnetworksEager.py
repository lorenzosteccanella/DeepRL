...
class PPOEagerSync:
    ...
    def __init__(self, h_size, n_actions, model_critic, target_model_critic, model_actor, target_model_actor, learning_rate, weight_mse, weight_ce, e_clip=0.2, tau=0.9, shared_observation_model=None, target_shared_observation_model=None, learning_rate_observation_adjust=1, train_observation=False):
...
class PPOEagerSeparate:
    ...
    def __init__(self, h_size, n_actions, model_critic, model_actor, target_model_actor, learning_rate, weight_mse, weight_ce, e_clip=0.2, tau=0.9,shared_observation_model=False, learning_rate_observation_adjust=False, train_observation=False):
