...
class GoalA2CSILOption(AbstractOption):
    ...
    def __init__(self, parameters):
        ...
        self.a2cDNN_SIL = GoalA2CSILEagerSeparate(parameters["h_size"], len(parameters["action_space"]), parameters["critic_network"],
    ...
    def get_state_value(self, s):
        ...
        return self.a2cDNN_SIL.prediction_critic([s],[i],[g])[0][0]
