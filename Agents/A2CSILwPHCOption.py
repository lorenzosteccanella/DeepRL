...
from Agents import A2CSILwPHCAgent
from Models.A2CSILnetworksEager import *
from copy import deepcopy

class A2CSILwPHCOption(AbstractOption):

    def __init__(self, parameters):

        super(A2CSILwPHCOption, self).__init__()
        ...
        self.agent = A2CSILwPHCAgent(parameters["action_space"], self.a2cDNN_SIL, parameters["gamma"], parameters["batch_size"],
